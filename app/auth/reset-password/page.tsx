...
import { confirmForgotPassword } from '@/lib/api/auth'
...
export default function ResetPasswordPage() {
  ...
  const isButtonDisabled = !verificationCode || !newPassword || !confirmPassword || !validatePassword(newPassword) || newPassword !== confirmPassword || isLoading
