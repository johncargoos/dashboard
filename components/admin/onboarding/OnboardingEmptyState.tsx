...
export function OnboardingEmptyState({ onStartOnboarding }: OnboardingEmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      {/* Title */}
      <h2 className="text-2xl font-bold text-gray-900 mb-2">No Onboarding Found</h2>

      {/* Description */}
      <p className="text-gray-600 text-center mb-8 max-w-md">
        Looks like there aren't any current onboarding processes to display. Start by adding a new one.
      </p>
